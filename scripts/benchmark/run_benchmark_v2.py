...
TOKENIZER_ID = PROJECT_ROOT / "scripts" / "training" / f"{MODEL_SIZE}_{DATASET_TYPE}_trained_models" / "final_tokenizer"
...
def load_model_and_tokenizer():
    ...
    if RESULT_TYPE == "baseline":
        ...
        tokenizer = AutoTokenizer.from_pretrained(str(TOKENIZER_ID))
